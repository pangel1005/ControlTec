  ...
  return (
    <div className="vus-layout">
      <header className="vus-header">
        <div>
          <h1>Bandeja Encargado UPC</h1>
          <p>
            Aquí revisas las solicitudes que el Técnico UPC dejó en{" "}
            <strong>{ESTADO_OBJETIVO}</strong> para remitirlas a la siguiente
            instancia (DIGEAMPS / DNCD) o devolverlas si hay observaciones.
          </p>
        </div>
        {usuario && (
